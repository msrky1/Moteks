                    ...
                    <div class="image-head p-relative">
                        <div class="before-z-index" data-dsn-grid="move-up" data-overlay="5">
                            <img class="cover-bg-img has-bigger-scale"
                                ...
                                data-dsn-src="{{asset('assets')}}/img/slider/18.jpg" alt="">
                        </div>
                    </div>
                                    ...
                                    <div class="box-info h-100 d-flex align-items-center pr-30 pt-50 pb-50">
                                        <div class="box-info-inner">
                                            <div class="title-cover" data-dsn-grid="move-section" data-dsn-opacity="0.1"
                                              ...
                                              <h2>  {{__('sustainability')}} </h2>
                                            </div>
                                            <div class="d-flex text-left flex-column align-items-start ">
                                                <div class="mb-30">

                                                    <h2 class="section-title  title-cap"> {{__('s7')}}</h2>

                                                </div>
                                            </div>


                                            <p class="max-w570  mb-10 border-top pt-30">
                                                {{__('s8')}}
                                            </p>

                                            <p class="max-w570  border-bottom pb-30">
                                                {{__('s9')}}
                                            </p>
                                ...
                                <div class="col-lg-6  dsn-z-index-2 pl-0">
                                    <div class="box-im h-100 ">
                                        <div class="img-container h-100" data-dsn-grid="move-up">
                                            <img class="cover-bg-img " data-dsn-speed="4"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-dsn-src="{{asset('assets')}}/img/slider/19.jpg" alt="">
                                        </div>
                                ...
                                <div class="d-grid grid-lg-3 grid-sm-2">
                                    <div class="service-lest-item p-relative">
                                        ...
                                        <div class="content ml-0">
                                            <h4 class="title-block mb-15">    {{__('s11')}}</h4>
                                            <p>    {{__('s12')}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-lest-item p-relative">
                                        ...
                                        <div class="content ml-0">
                                            <h4 class="title-block mb-15">    {{__('s13')}}</h4>
                                            <p>    {{__('s14')}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-lest-item p-relative">
                                        ...
                                        <div class="content ml-0">
                                            <h4 class="title-block mb-15">    {{__('s15')}}</h4>
                                            <p>{{__('s16')}}</p>
                                        </div>
                                    </div>
                                </div>
